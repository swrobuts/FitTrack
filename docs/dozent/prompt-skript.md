...
Beschreibung aller Tests: `docs/dozent/tests.md`. Die Referenzlösung hat 46: 15 entstehen auf dem Bauweg, neun gehören zum Trainingsbot und 22 zum MCP-Server, beide nach dem Kurs dazugekommen.
